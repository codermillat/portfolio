        ...
        <div className={`transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="space-y-8">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {/* My Journey Card */}
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 relative overflow-hidden group hover:shadow-xl transition-all duration-300 min-h-[280px] flex flex-col">
                ...
                <div className="relative z-10 flex-1 flex flex-col">
                  ...
                  <div className="space-y-3 text-gray-700 leading-relaxed flex-1">
              ...
              {/* Philosophy Card */}
              <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-xl p-6 text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300 min-h-[280px] flex flex-col">
            ...
            <div className="min-h-[280px] flex items-center justify-center">
              <div className="flex items-center gap-3 text-primary-700 bg-white rounded-lg p-6 shadow-lg border border-gray-100 max-w-lg w-full">
                <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center">
                  <MapPin size={20} className="text-primary-700" />
                </div>
                <div>
                  <p className="font-semibold text-gray-900 text-lg">Based in Greater Noida, India</p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {/* At a Glance */}
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 min-h-[320px] flex flex-col">
