    ...
    <section id="about" ref={sectionRef} className="py-12 lg:py-20 px-4 lg:px-6 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className={`transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          {/* Perfectly Balanced Grid Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Row 1, Column 1: My Journey */}
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:shadow-xl transition-all duration-300 h-80 flex flex-col">
            ...
            {/* Row 1, Column 2: Philosophy */}
            <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-xl p-8 text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300 h-80 flex flex-col">
          ...
          <div className="mb-8">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:shadow-xl transition-all duration-300 h-80 flex items-center justify-center">
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-primary-100/30 to-transparent rounded-full -translate-y-12 translate-x-12" />
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-8 text-center lg:text-left w-full max-w-4xl">
                <div className="w-24 h-24 bg-primary-100 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-primary-200 transition-colors duration-300">
                  <MapPin size={40} className="text-primary-700" />
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 text-3xl lg:text-4xl mb-4">Based in Greater Noida, India</h3>
                  <p className="text-xl lg:text-2xl text-gray-600 mb-6">Open to remote opportunities worldwide</p>
                  <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                    <span className="px-4 py-2 bg-primary-50 text-primary-700 rounded-full text-base font-medium border border-primary-200">
                      Remote Ready
                    </span>
                    <span className="px-4 py-2 bg-green-50 text-green-700 rounded-full text-base font-medium border border-green-200">
                      Available Now
                    </span>
                  </div>
                </div>
          ...
          {/* Row 3: At a Glance and Core Strengths */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* At a Glance */}
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100 h-80 flex flex-col">
              <h3 className="text-2xl font-semibold text-gray-900 mb-8 text-center">At a Glance</h3>
              
              <div className="grid grid-cols-2 gap-6 flex-1">
                <div className="text-center group">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-center group">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-center group">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-center group">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform duration-300">
          ...
          <div>
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-8 text-white shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300 h-80 flex items-center justify-center">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-16 translate-x-16" />
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/5 rounded-full translate-y-12 -translate-x-12" />
              
              <div className="relative z-10 text-center w-full max-w-4xl">
                <h3 className="text-3xl font-semibold mb-6">Currently Exploring</h3>
