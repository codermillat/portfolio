...
const Creative: React.FC = () => {
  ...
  return (
    <section id="creative" ref={sectionRef} className="py-16 lg:py-32 px-6 lg:px-8 bg-gray-900 relative overflow-hidden">
      {/* Background Elements */}
              ...
              <div className="lg:flex">
                ...
                <div className="lg:w-2/5 relative">
                  <div className="aspect-video lg:aspect-square bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 w-8 h-8 border border-white/20 rounded-full hidden lg:block" />
                    <div className="absolute bottom-6 right-6 w-6 h-6 border border-white/20 rounded-lg hidden lg:block" />
                  </div>
                </div>
